...
CREATE TABLE IF NOT EXISTS analytics.panel_alcaldia_anio (
    ...
    cassi_wmean double precision,
    cyt_wmean double precision,
    total_delitos_fgj numeric,
    share_robos_patrimoniales_sobre_total_delitos double precision,
    target_robos_patrimoniales_total numeric,
    robo_a_transeunte numeric,
    robo_a_negocio numeric,
    robo_a_casa_habitacion numeric,
    robo_de_vehiculo numeric,
    robo_de_accesorios_auto numeric,
    robo_del_interior_de_vehiculo numeric,
    target_robos_log1p double precision,
